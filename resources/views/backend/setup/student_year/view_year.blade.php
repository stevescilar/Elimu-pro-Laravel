                      ...
                      <tbody>
                        @foreach($allData as $key => $year)
                          <tr>
                              ...
                              <td>
                                <a href="{{ route('student.year.edit',$year->id) }}" class="btn btn-info"><i class="mdi mdi-account-edit"></i> Edit</a> &nbsp;
                                <a href="{{ route('student.year.delete',$year->id) }}" class="btn btn-danger" id="delete"><i class="mdi mdi-account-remove"></i> Delete</a>
                              </td>
                          </tr>
                        @endforeach
                      </tbody>
